...
impl SNP {
    ...
    pub fn translate(&self, read: &str, read_pos: u32, read_qual: &[u8], reference: &fasta::Record, gene: &Gene, min_quality: u8) -> Option<String> {
        ...
        if read_qual[alt_start_pos..alt_end_pos].iter().any(|&qual| qual < min_quality) {
            return None;
        }
